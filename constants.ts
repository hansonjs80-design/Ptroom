...
export const STANDARD_TREATMENTS: QuickTreatment[] = [
  { id: 'qt-1', name: '핫팩 (Hot Pack)', label: 'H', duration: 10, color: 'bg-red-500', enableTimer: true },
  { id: 'qt-2', name: 'ICT', label: 'i', duration: 10, color: 'bg-blue-500', enableTimer: true },
  ...
  { id: 'qt-5', name: '자기장 (Magnetic)', label: '자', duration: 10, color: 'bg-purple-500', enableTimer: true },
