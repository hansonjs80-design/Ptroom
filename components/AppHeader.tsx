...
export const AppHeader: React.FC<AppHeaderProps> = ({
  ...
  return (
    ...
    <header className="flex flex-col justify-end w-full h-full bg-white/75 dark:bg-slate-950/75 backdrop-blur-md border-b border-slate-200/50 dark:border-slate-800/50 z-30 pt-[env(safe-area-inset-top)] transition-colors duration-300">
      ...
      */}
      <div className="flex items-center justify-between px-2 sm:px-5 h-[52px] sm:h-[72px] md:h-[52px] xl:h-[72px] landscape:h-12 shrink-0 max-w-[1600px] mx-auto w-full">

        {/* Left: Menu & Logo */}
        <div className="flex items-center gap-1 sm:gap-4 md:gap-3 xl:gap-4">
          <button
            onClick={onOpenMenu}
          ...
          <div className="flex items-center gap-2 select-none group cursor-default">
            ...
            */}
            <h1 className="text-lg sm:text-3xl md:text-xl xl:text-3xl landscape:text-lg font-black text-slate-800 dark:text-white tracking-tighter leading-none flex items-center">
