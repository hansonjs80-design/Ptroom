      ...
      >
        ...
        `}>
          {/* 
            ...
            */}
          <span className={`font-black text-base xs:text-lg sm:text-xl md:text-2xl md:portrait:text-3xl lg:text-3xl leading-none text-center whitespace-nowrap px-0.5 ${isActive ? 'scale-110 drop-shadow-sm' : 'opacity-90'}`}>
