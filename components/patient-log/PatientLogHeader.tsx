...
export const PatientLogHeader: React.FC<PatientLogHeaderProps> = ({
  ...
  return (
    <div className="shrink-0 z-20 flex flex-row items-center justify-between px-3 sm:px-4 pb-3 pt-[calc(env(safe-area-inset-top)+0.75rem)] bg-white/80 dark:bg-slate-900/80 backdrop-blur-md border-b border-slate-200/60 dark:border-slate-800 transition-colors">
